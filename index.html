...
<head>
  ...
  <title>Jean Therane -Portfolio Website</title>
...
<body>
  ...
  <section class="home" id="home">
    <div class="home-content">
      ...
      <h6 class="text-animation"><span> </span></h6>
      <p>
      ...
      <div class="social-icons">
        ...
        <a href="https://github.com/jewathe"><i class='bx bxl-github'></i></box-icon></a>
       <!--       
    ...
    <div class="services-container">
      <div class="service-box">
        <div class="service-info">
          ...
          <p> Conception et Développement d'Interfaces Utilisateur (UI)
            ...
            technologies front-end telles que HTML, CSS, SCSS, Bootstrap.
            pour concevoir des interfaces utilisateur attractives et faciles à naviguer.
            <a href="https://github.com/jewathe/restaurant" class="plus"><i class='bx bxl-github'></i></box-icon></i></a>
          </p>
      ...
      <div class="service-box">
        <div class="service-info">
          ...
          <p>
            1.Frameworks modernes: React pour développer des interfaces réactives et
            dynamiques.
            2. Intégration des services backend via des APIs RESTful
            pour assurer une communication efficace entre le front-end et le back-end.
            <a href="https://github.com/jewathe/react-recipe" class="plus"><i class='bx bxl-github'></i></box-icon></i></a>
          </p>
	        ...
	        <div class="service-box">
        <div class="service-info">
          <h4>Développeur Angular</h4>
          <p>
            1.Frameworks modernes: Angular pour développer des interfaces réactives et
            dynamiques.
            2. Intégration des services backend via des APIs RESTful
            pour assurer une communication efficace entre le front-end et le back-end.
            <a href="https://github.com/jewathe/angular-cars" class="plus"><i class='bx bxl-github'></i></box-icon></i></a>
          </p>
	  ...
	  <div class="service-box">
        <div class="service-info">
          <h4>Développeur Node.js et PostgreSQL</h4>
          <p> Conception et développement de serveurs
            robustes et d'API RESTful avec Node.js,
            Express.
            Conception et gestion de bases de données PostgreSQL.
            <a href="https://github.com/jewathe/server-express-postgres" class="plus"><i class='bx bxl-github'></i></box-icon></i></a>
          </p>
      ...
      <div class="service-box">
        <div class="service-info">
          <h4>Développeur Node.js et fichier JSON</h4>
          <p> Conception et développement de serveurs
            robustes et d'API RESTful avec Node.js,
            Express.
            Avec les données du fichier JSON.
            <a href="https://github.com/jewathe/server-express" class="plus"><i class='bx bxl-github'></i></box-icon></i></a>
          </p>
